...
The prices are based on an average of everything, so 1st Ed and Unlimited, etc. Once Cardmarket open up the API, I will be able to specify this to 1st Edition as this is what collectors want.
